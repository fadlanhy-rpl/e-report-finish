...
<div class="relative overflow-x-auto sm:rounded-lg">
    <div class="pb-4 flex justify-end">
        <!-- Modal toggle -->
        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-[#243757] hover:bg-[#0B1D45] focus:ring-4 focus:outline-none focus:ring-[#0b1d45] font-medium rounded-lg text-sm px-5 py-2.5 text-center" type="button">
            Add user
        </button>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500" id="pagination-table">
        <thead class="text-xs text-white uppercase bg-[#243757]">
            <tr>
        ...
        <tbody>
            ...
            ?>
                <?php foreach ($users as $user) : ?>
                    <tr class="bg-[#243757] border-b hover:bg-[#0b1d45] text-white">
