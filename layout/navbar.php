<div class="antialiased">
    <!-- Navbar -->
    <nav class="bg-[#F4F4FE] shadow-sm px-4 py-4 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center ">
            <div class="flex justify-start items-center">
                ...
                <a href="/" class="flex items-center justify-between mr-4">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap">Quantum<span class="text-[#222D49] font-bold">data</span></span>
                </a>

                <!-- Tab Name -->
                <h4 class="hidden lg:block lg:text-2xl font-bold text-primary ml-12 text-[#222D49] "><?= ucwords($_GET['page']) ?></h4>
            ...
            <div class="flex items-center gap-3 lg:order-2">
                ...
                ?>
                    <a href="index.php?page=create" type="button" class="group inline-flex items-center px-4 py-2 text-sm font-medium text-[#243757] bg-transparent border border-[#243757] rounded hover:bg-[#0b1d45] hover:text-white focus:z-10 focus:ring-2 ">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown" class="flex items-center justify-center relative w-9 h-9 rounded-xl text-gray-600 bg-blue-200 hover:bg-acent1 hover:text-white focus:bg-acent1 focus:text-white transition-all duration-200">
                    <span class="absolute flex h-5 w-6 -top-2 -right-3">
                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#243757] opacity-75"></span>
                        <span class="relative flex items-center justify-center rounded-full h-6 w-6 bg-[#243757] text-[9px] text-white">08</span>
                    </span>
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-500 dark:bg-gray-100 rounded-xl" id="notification-dropdown">
                    <h4 class="block py-2 px-4 text-base font-medium text-center text-white bg-[#243757]">Notifications</h4>
                    <div>
                    ...
                    <a href="#" class="block py-2 text-md font-medium text-center text-white bg-[#243757] hover:bg-[#0b1d45]">
