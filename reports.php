...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
    ...
    <div class="border-[#243757] border-4 rounded-lg shadow h-fit flex flex-col justify-between col-span-1 md:col-span-1 hidden md:block">
        <div class="p-5">
        ...
        <div class="p-5">
            ...
            <button class="w-full outline-[#243757] outline rounded text-[#243757] font-normal text-lg p-1 hover:bg-[#243757] hover:text-white hover:font-bold">Read more</button>
        </div>
    </div>
